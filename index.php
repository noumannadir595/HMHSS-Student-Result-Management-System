...
<html lang="en">
    <head>
        ...
        <title>HMHSS - Student Result Management System</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="index.php">HMHSS-(Student Result Management System)</a>
...
<?php }} ?>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white"> Developed By Nouman Nadir</p></div>
        </footer>
        <!-- Bootstrap core JS-->
